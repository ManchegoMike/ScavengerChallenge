...
ns["enUS"] = {
    ...
    bank_help = "Allow or disallow using the bank",
    ...
    hearth_help = "Allow or disallow using a hearthstone",
    hearth_off = "Hearthing is now forbidden",
    hearth_on = "Hearthing is now allowed",
    id_name_link = "id/name/link",
    init_desc = function(hearthOK, bankOK) return "No deaths, no trading, no mail, no auction house, no quest rewards, no buying from vendors (except a fishing pole and a mount), " .. (hearthOK and "hearthing OK" or "no hearthing") .. ", " .. (bankOK and "banking OK" or "no banking") end,
    ...
    mail_help = "Allows you to use mail for one minute (for quests only)",
    ...
    trade_help = "Allows you to trade for one minute (for emergencies only)",
