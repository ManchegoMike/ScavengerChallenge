...
ns["enUS"] = {
    ...
    bank_help = function(max) return "Allow or disallow using the bank (decide before level " .. max .. ")" end,
    ...
    hearth_help = function(max) return "Allow or disallow using a hearthstone (decide before level " .. max .. ")" end,
