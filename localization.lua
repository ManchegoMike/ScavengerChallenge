...
ns["enUS"] = {
    ...
    help_allow_desc = "Allow an item you specify",
    help_disallow_desc = "Disallow an item you specify",
    ...
    help_mail = "Allows you to use mail for one minute",
    mail_activated = "You can now use mail for one minute",
    mail_deactivated = "Mail is now deactivated",
    no_trade = "You cannot trade",
    help_trade = "Allows you to trade for one minute",
    trade_activated = "You can now trade for one minute",
    trade_deactivated = "Trading is now deactivated",
