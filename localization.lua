...
ns["enUS"] = {
    ...
    currently_off = "currently disallowed",
    currently_on = "currently allowed",
    ...
    init_base = "No dying, no trading, no mail, no auction house, no quest rewards, no buying from vendors (except a fishing pole and a mount)",
